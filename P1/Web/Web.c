...
/* Last-Modified: Mon,    Mar 2026 21:42:09 GMT */
const uint32_t imageLastModified = 1772487729U;

static const uint8_t imageFileData[24651U] = {
...
static const imageFileItem imageFileTable[19U+1U] = {
  ...
  { 0xB0E380D2U, &imageFileData[5676U]  },    // "ad.cgx"
  { 0xF46138EAU, &imageFileData[5745U]  },    // "buttons.cgi"
  { 0xBCB1FE2DU, &imageFileData[7438U]  },    // "buttons.cgx"
  { 0xD7FABA9AU, &imageFileData[7478U]  },    // "language.cgi"
  { 0x6314E402U, &imageFileData[8382U]  },    // "lcd.cgi"
  { 0xD1C9C758U, &imageFileData[9068U]  },    // "leds.cgi"
  { 0xCEC97D75U, &imageFileData[10349U] },    // "network.cgi"
  { 0x69E9F01DU, &imageFileData[12497U] },    // "system.cgi"
  { 0x5579E5A7U, &imageFileData[13748U] },    // "tcp.cgi"
  { 0xEEA8CB3DU, &imageFileData[14392U] },    // "xml_http.js"
  { 0xDE703953U, &imageFileData[17208U] },    // "home.png"
  { 0x90CE4E8AU, &imageFileData[18597U] },    // "keil.gif"
  { 0xA35A02C8U, &imageFileData[19735U] },    // "logo.gif"
  { 0x7049A0E1U, &imageFileData[21522U] },    // "llblue.jpg"
  { 0x3BDBDB05U, &imageFileData[24530U] },    // "pabb.gif"
  { 0x00000000U, &imageFileData[24651U] }
};
